...
public class MainWindow extends JFrame {
	...
	private OwnBoardCanvasController controllerForOwnBoardCanvas;
	private EnemyBoardCanvasController controllerForEnemyBoardCanvas;
	private MainWindowLeftPaneController controllerForLeftPane;
	private Model model;
	...
	private JLabel lblPlayerNameText;
	private JLabel labelShotsQty;
	private JLabel lblHitsQty;
	private JLabel lblMissesQty;
	private JLabel lblShipsQty;
	private JLabel lblShipsAliveQty;
	private JLabel lblShipsSunkQty;
	
	private JTextField txtXFire;
	private JTextField txtYFire;
	
	private JLabel lblCarrierQty;
	private JLabel lblBattleshipQty;
	private JLabel lblCruiserQty;
	private JLabel lblSubmarineQty;
	private JLabel lblDestroyerQty;
	
	private JLabel lblLengthCarrier;
	private JLabel lblLengthBattleship;
	private JLabel lblLengthCruiser;
	private JLabel lblLengthSubmarine;
	private JLabel lblLengthDestroyer;
	
	private JRadioButton rdbtnHorizontal;
	private JRadioButton rdbtnVertical;
	
	private Canvas ownBoardCanvas;
	private Canvas enemyBoardCanvas;
	
	private JRadioButton rdBtnCarrier;
	private JRadioButton rdBtnBattleship;
	private JRadioButton rdBtnCruiser;
	private JRadioButton rdBtnSubmarine;
	private JRadioButton rdBtnDestroyer;
	...
	public MainWindow(Model model) {
		...
		lblPlayerName.setBounds(23, 105, 112, 16);
		contentPane.add(lblPlayerName);
		
		lblPlayerNameText = new JLabel("player 1");
		...
		label_7.setBounds(515, 68, 56, 16);
		contentPane.add(label_7);
		
		JLabel label_8 = new JLabel("7");
		label_8.setHorizontalAlignment(SwingConstants.RIGHT);
		label_8.setBounds(555, 68, 56, 16);
		contentPane.add(label_8);
		
		JLabel label_18 = new JLabel("8");
		label_18.setHorizontalAlignment(SwingConstants.RIGHT);
		label_18.setBounds(595, 68, 56, 16);
		...
		lblLength.setBounds(195, 344, 112, 16);
		contentPane.add(lblLength);
		
		lblLengthCarrier = new JLabel("0");
		lblLengthCarrier.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblLengthCarrier.setBounds(208, 388, 56, 16);
		contentPane.add(lblLengthCarrier);
	...
	public Canvas getOwnBoardCanvas(){
		return ownBoardCanvas;
	}
	
	public Canvas getEnemyBoardCanvas(){
		return enemyBoardCanvas;
	}
	
	protected void captureEvents() {
		ownBoardCanvas.addMouseListener(getControllerForOwnBoardCanvas());
		enemyBoardCanvas.addMouseListener(getControllerForEnemyBoardCanvas());
		
	}
	
	public OwnBoardCanvasController getControllerForOwnBoardCanvas(){
		if(controllerForOwnBoardCanvas == null){
			controllerForOwnBoardCanvas = new OwnBoardCanvasController(this);
		}
		return controllerForOwnBoardCanvas;
	}
	
	public EnemyBoardCanvasController getControllerForEnemyBoardCanvas(){
		if(controllerForEnemyBoardCanvas == null){
			controllerForEnemyBoardCanvas = new EnemyBoardCanvasController(this);
		}
		return controllerForEnemyBoardCanvas;
	}
	
	public MainWindowLeftPaneController getControllerForLeftPane(){
		if(controllerForLeftPane == null){
			controllerForLeftPane = new MainWindowLeftPaneController(this);
		}
		return controllerForLeftPane;
	}
	...
	public JLabel getLblCarrierQty() {
		return lblCarrierQty;
	}

	public void setLblCarrierQty(JLabel lblCarrierQty) {
		this.lblCarrierQty = lblCarrierQty;
	}

	public JLabel getLblBattleshipQty() {
		return lblBattleshipQty;
	}

	public void setLblBattleshipQty(JLabel lblBattleshipQty) {
		this.lblBattleshipQty = lblBattleshipQty;
	}

	public JLabel getLblCruiserQty() {
		return lblCruiserQty;
	}

	public void setLblCruiserQty(JLabel lblCruiserQty) {
		this.lblCruiserQty = lblCruiserQty;
	}

	public JLabel getLblSubmarineQty() {
		return lblSubmarineQty;
	}

	public void setLblSubmarineQty(JLabel lblSubmarineQty) {
		this.lblSubmarineQty = lblSubmarineQty;
	}

	public JLabel getLblDestroyerQty() {
		return lblDestroyerQty;
	}

	public void setLblDestroyerQty(JLabel lblDestroyerQty) {
		this.lblDestroyerQty = lblDestroyerQty;
	}

	public JLabel getLblLengthCarrier() {
		return lblLengthCarrier;
	}

	public void setLblLengthCarrier(JLabel lblLengthCarrier) {
		this.lblLengthCarrier = lblLengthCarrier;
	}

	public JLabel getLblLengthBattleship() {
		return lblLengthBattleship;
	}

	public void setLblLengthBattleship(JLabel lblLengthBattleship) {
		this.lblLengthBattleship = lblLengthBattleship;
	}

	public JLabel getLblLengthCruiser() {
		return lblLengthCruiser;
	}

	public void setLblLengthCruiser(JLabel lblLengthCruiser) {
		this.lblLengthCruiser = lblLengthCruiser;
	}

	public JLabel getLblLengthSubmarine() {
		return lblLengthSubmarine;
	}

	public void setLblLengthSubmarine(JLabel lblLengthSubmarine) {
		this.lblLengthSubmarine = lblLengthSubmarine;
	}

	public JLabel getLblLengthDestroyer() {
		return lblLengthDestroyer;
	}

	public void setLblLengthDestroyer(JLabel lblLengthDestroyer) {
		this.lblLengthDestroyer = lblLengthDestroyer;
	}
	...
	public JRadioButton getRdBtnCarrier() {
		return rdBtnCarrier;
	}

	public JRadioButton getRdBtnBattleship() {
		return rdBtnBattleship;
	}

	public JRadioButton getRdBtnCruiser() {
		return rdBtnCruiser;
	}

	public JRadioButton getRdBtnSubmarine() {
		return rdBtnSubmarine;
	}

	public JRadioButton getRdBtnDestroyer() {
		return rdBtnDestroyer;
	}
